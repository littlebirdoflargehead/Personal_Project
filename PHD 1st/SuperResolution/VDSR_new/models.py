...
class SRDenseNet_H:
    ...
    def create_sr_model(self,ip):
        ...
        '反卷积层'
        y = Deconv2D(128,kernel_size=self.kernel_size,activation='relu',strides=2,padding='same')(x_8)
        y = Deconv2D(128,kernel_size=self.kernel_size,activation='relu',strides=2,padding='same')(y)
        '重构层'
...
class SRDenseNet_HL:
    ...
    def create_sr_model(self,ip):
        ...
        '反卷积层'
        y = Deconv2D(128,kernel_size=self.kernel_size,activation='relu',strides=2,padding='same')(sk)
        y = Deconv2D(128,kernel_size=self.kernel_size,activation='relu',strides=2,padding='same')(y)
        '重构层'
        outputs = Conv2D(self.channels, kernel_size=self.kernel_size, padding='same')(y)
...
class SRDenseNet_ALL:
    ...
    def create_sr_model(self,ip):
        ...
        '反卷积层'
        y = Deconv2D(128,kernel_size=self.kernel_size,activation='relu',strides=2,padding='same')(bn)
        y = Deconv2D(128,kernel_size=self.kernel_size,activation='relu',strides=2,padding='same')(y)
        '重构层'
        outputs = Conv2D(self.channels, kernel_size=self.kernel_size, padding='same')(y)
