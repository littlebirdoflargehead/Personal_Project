...
# Config._parse({'load_model_path':'checkpoints/vae-190917_20:50:13.pth'})  # tensor z / with sigmoid / determined logvar
Config._parse({'load_model_path':'checkpoints/vae-190918_21:54:21.pth'})  # tensor z / with sigmoid / determined logvar
